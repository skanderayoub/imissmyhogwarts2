...
const wandData = {
    ...
    flexibilities: {
        Determination: {
            "an even number": "unbending",
            "an odd date": "reasonably supple",
        },
        Imagination: {
            "an even number": "surprisingly swishy",
            "an odd date": "slightly springy",
        },
        ...
        Kindness: {
            "an even number": "slightly yielding",
            "an odd date": "quite flexible",
        },
    },
    woods: {
        "Dark brown / Black": {
            Determination: {
                "left towards the sea": "Beech",
                "ahead towards the forest": "Ebony",
                "right towards the castle": "Aspen",
            },
            Imagination: {
                "left towards the sea": "Sycamore",
                "ahead towards the forest": "English Oak",
                "right towards the castle": "Alder",
            },
            Resilience: {
                "left towards the sea": "Larch",
                "ahead towards the forest": "Apple",
                "right towards the castle": "Pine",
            },
            Intelligence: {
                "left towards the sea": "Ash",
                "ahead towards the forest": "Hazel",
                "right towards the castle": "Black Walnut",
            },
            Originality: {
                "left towards the sea": "Acacia",
                "ahead towards the forest": "Cedar",
                "right towards the castle": "Redwood",
            },
            Optimism: {
                "left towards the sea": "Laurel",
                "ahead towards the forest": "Spruce",
                "right towards the castle": "Hornbeam",
            },
            Kindness: {
                "left towards the sea": "Silver Lime",
                "ahead towards the forest": "Rowan",
                "right towards the castle": "Vine",
            },
        },
        Brown: {
            Determination: {
                "left towards the sea": "Fir",
                "ahead towards the forest": "Yew",
                "right towards the castle": "Sycamore",
            },
            Imagination: {
                "left towards the sea": "Cypress",
                "ahead towards the forest": "Cedar",
                "right towards the castle": "Spruce",
            },
            Resilience: {
                "left towards the sea": "Laurel",
                "ahead towards the forest": "Rowan",
                "right towards the castle": "Maple",
            },
            Intelligence: {
                "left towards the sea": "Redwood",
                "ahead towards the forest": "Dogwood",
                "right towards the castle": "Chestnut",
            },
            Originality: {
                "left towards the sea": "Pine",
                "ahead towards the forest": "Hazel",
                "right towards the castle": "Beech",
            },
            Optimism: {
                "left towards the sea": "Vine",
                "ahead towards the forest": "Apple",
                "right towards the castle": "Elm",
            },
            Kindness: {
                "left towards the sea": "Acacia",
                "ahead towards the forest": "Pear",
                "right towards the castle": "Laurel",
            },
        },
        Hazel: {
            Determination: {
                "left towards the sea": "Cedar",
                "ahead towards the forest": "English Oak",
                "right towards the castle": "Hazel",
            },
            Imagination: {
                "left towards the sea": "Dogwood",
                "ahead towards the forest": "Yew",
                "right towards the castle": "Hawthorn",
            },
            Resilience: {
                "left towards the sea": "Vine",
                "ahead towards the forest": "Ebony",
            ...
            Intelligence: {
                "left towards the sea": "Elm",
                "ahead towards the forest": "Blackthorn",
                "right towards the castle": "Fir",
            },
            Originality: {
                "left towards the sea": "Chestnut",
                "ahead towards the forest": "Sycamore",
                "right towards the castle": "Ash",
            },
            Optimism: {
                "left towards the sea": "Redwood",
                "ahead towards the forest": "Pear",
            ...
            Kindness: {
                "left towards the sea": "Cherry",
                "ahead towards the forest": "Red Oak",
                "right towards the castle": "Maple",
            },
        },
        Blue: {
            Determination: {
                "left towards the sea": "Hazel",
                "ahead towards the forest": "Cedar",
                "right towards the castle": "Beech",
            },
            Imagination: {
                "left towards the sea": "Larch",
                "ahead towards the forest": "Holly",
                "right towards the castle": "Laurel",
            },
            Resilience: {
                "left towards the sea": "Redwood",
                "ahead towards the forest": "Yew",
                "right towards the castle": "Walnut",
            },
            Intelligence: {
                "left towards the sea": "Cypress",
                "ahead towards the forest": "Alder",
                "right towards the castle": "Elder",
            },
            Originality: {
                "left towards the sea": "Elm",
                "ahead towards the forest": "Fir",
                "right towards the castle": "Sycamore",
            },
            Optimism: {
                "left towards the sea": "Maple",
                "ahead towards the forest": "Rowan",
                "right towards the castle": "Pine",
            },
            Kindness: {
                "left towards the sea": "Willow",
                "ahead towards the forest": "English Oak",
                "right towards the castle": "Hawthorn",
            },
        },
        "Blue / Grey": {
            Determination: {
                "left towards the sea": "Sycamore",
                "ahead towards the forest": "Holly",
                "right towards the castle": "Cedar",
            },
            Imagination: {
                "left towards the sea": "Rowan",
                "ahead towards the forest": "Pear",
                "right towards the castle": "Ebony",
            },
            Resilience: {
                "left towards the sea": "Maple",
                "ahead towards the forest": "Cypress",
                "right towards the castle": "Poplar",
            },
            Intelligence: {
                "left towards the sea": "Hawthorn",
                "ahead towards the forest": "Spruce",
                "right towards the castle": "Sycamore",
            },
            Originality: {
                "left towards the sea": "Cherry",
                "ahead towards the forest": "Beech",
                "right towards the castle": "Elm",
            },
            Optimism: {
                "left towards the sea": "Hornbeam",
                "ahead towards the forest": "Alder",
                "right towards the castle": "Ash",
            },
            Kindness: {
                "left towards the sea": "Pear",
                "ahead towards the forest": "Larch",
                "right towards the castle": "Redwood",
            },
        },
        "Blue / Green": {
        ...
        Green: {
            Determination: {
                "left towards the sea": "Rowan",
                "ahead towards the forest": "Walnut",
                "right towards the castle": "Fir",
            },
            Imagination: {
                "left towards the sea": "Hornbeam",
        ...
        Grey: {
            Determination: {
                "left towards the sea": "Cypress",
                "ahead towards the forest": "Hornbeam",
                "right towards the castle": "Ash",
            },
            Imagination: {
                "left towards the sea": "Silver Lime",
            ...
            Intelligence: {
                "left towards the sea": "Pear",
                "ahead towards the forest": "Chestnut",
                "right towards the castle": "Ebony",
            },
            Originality: {
                "left towards the sea": "Hawthorn",
        ...
        Other: {
            ...
            Optimism: {
                "left towards the sea": "Ash",
                "ahead towards the forest": "Elm",
                "right towards the castle": "Walnut",
            },
            Kindness: {
                "left towards the sea": "Larch",
                "ahead towards the forest": "Cypress",
                "right towards the castle": "Blackthorn",
            },
        },
    },
};
...
const wandDescriptions = {
    cores: {
        Dragon:
            "A wand with a dragon heartstring core, powerful and capable of flamboyant spells, often bonding with those of strong will.",
        Unicorn:
            "A wand with a unicorn hair core, consistent and loyal, producing magic that is pure and difficult to turn to the Dark Arts.",
        Phoenix:
            "A wand with a phoenix feather core, versatile and rare, capable of a wide range of magic and choosing those with great potential.",
    },
    woods: {
        Acacia:
            "A subtle wood, suited for those with a delicate touch and nuanced magic.",
        Alder: "A helpful wood, ideal for non-verbal spells and loyal companions.",
        Apple:
            "A charming wood, often wielded by those with personal charisma and high ideals.",
        Ash: "A steadfast wood, clinging to its true owner and excelling in protective magic.",
        Aspen:
            "A duelist’s wood, known for its strength in charm work and revolutionary spirit.",
        ...
        BlackWalnut:
            "A perceptive wood, requiring a master with clear intentions and self-awareness.",
        Cedar:
            "A loyal wood, drawn to those with strength of character and loyalty.",
        Cherry:
            "A rare wood, granting exceptional power in charm work and requiring great control.",
        Chestnut:
            "A versatile wood, influenced by the core and the wielder’s personality.",
        ...
        Ebony:
            "A striking wood, suited for combative magic and those who hold fast to their beliefs.",
        Elder:
            "A rare and powerful wood, difficult to master and choosing those with exceptional destinies.",
        ...
        Hawthorn:
            "A complex wood, suited for healing and curses, and those with a conflicted nature.",
        Hazel:
            "A sensitive wood, reflecting its owner’s emotions and excelling in skilled hands.",
        Holly:
            "A protective wood, often choosing those with a need for overcoming anger or impulsiveness.",
        Hornbeam: "A refined wood, bonding closely with its owner’s moral vision.",
        Larch:
            "A hidden strength wood, unlocking talents in those with unexpected resilience.",
        Laurel:
            "An honorable wood, seeking those who avoid laziness and strive for glory.",
        Maple:
            "A traveler’s wood, thriving in the hands of the ambitious and adaptable.",
        ...
        Poplar:
            "A reliable wood, producing consistent magic for those with clear moral vision.",
        RedOak:
            "A quick wood, ideal for those with fast reactions and adaptability.",
        Redwood:
            "A fortunate wood, drawn to those who seize opportunities and escape danger.",
        Rowan:
            "A protective wood, strong in defensive magic and favoring the pure-hearted.",
        SilverLime:
            "A mystical wood, popular among seers and those skilled in Legilimency.",
        Spruce: "A bold wood, requiring a firm hand and a humorous spirit.",
        Sycamore:
            "A curious wood, eager for new experiences and burning bright in adventurous hands.",
        Vine: "An intuitive wood, seeking those with hidden depths and vision.",
        Walnut:
            "A versatile wood, excelling in the hands of innovative and intelligent wielders.",
    ...
    flexibilities: {
        ...
        "reasonably supple":
            "A reasonably supple wand, balancing flexibility with strength.",
        "surprisingly swishy":
            "A surprisingly swishy wand, lively and adaptable to creative magic.",
        "slightly springy":
            "A slightly springy wand, responsive and dynamic in spellcasting.",
        rigid: "A rigid wand, suited for those with unwavering focus.",
        supple:
            "A supple wand, versatile and accommodating to its wielder’s needs.",
        ...
        brittle:
            "A brittle wand, delicate yet capable of precise and intricate spells.",
        ...
        "slightly yielding":
            "A slightly yielding wand, offering a balance of control and flexibility.",
        "quite flexible":
            "A quite flexible wand, versatile and responsive to a wide range of magic.",
    },
};
...
function renderQuiz() {
    ...
    if (currentQuestionIndex === 3) {
        const initialSelectionUrls = [
            getRandomAudio(wandAudio.Selection.Hesitation),
            getRandomAudio(wandAudio.Selection["Try this"]),
            wandAudio.Selection["Swish it!"],
        ];
        playAudioSequence(
            initialSelectionUrls,
            "Looking for a suitable wand...",
            () => {
                quizContainer.innerHTML = `
                <h3 class="text-xl font-harry-potter text-yellow-300 mb-4">Swish your wand!</h3>
                <div class="flex justify-center">
                <button id="try-wand" class="btn-normal bg-gray-800 bg-opacity-70 rounded-lg text-yellow-200 hover-transition transition-all px-4 py-2 font-harry-potter text-lg">
                    Try your wand!
                </button>
                </div>
            `;
                progressContainer.innerHTML = `
                <p class="text-yellow-200">Question ${currentQuestionIndex + 1
                    } of ${quizData.length}</p>
                <div class="w-full bg-gray-700 rounded-full h-2">
                    <div class="bg-yellow-400 h-2 rounded-full" style="width: ${((currentQuestionIndex + 1) / quizData.length) * 100
                    }%"></div>
                </div>
            `;
                document.getElementById("try-wand").addEventListener("click", () => {
                    const remainingSelectionUrls = [
                        ...
                        wandAudio.Selection["Don't worry"],
                    ];
                    playAudioSequence(
                        remainingSelectionUrls,
                        "Testing your wand...",
                        () => {
                            quizContainer.innerHTML = `
                        <h3 class="text-xl font-harry-potter text-yellow-300 mb-4">It seems like I need to know more about you...</h3>
                        <div class="flex justify-center">
                        <button id="continue-quiz" class="btn-normal bg-gray-800 bg-opacity-70 rounded-lg text-yellow-200 hover-transition transition-all px-4 py-2 font-harry-potter text-lg">
                            Continue
                        </button>
                        </div>
                    `;
                        ...
                        <div class="w-full bg-gray-700 rounded-full h-2">
                            <div class="bg-yellow-400 h-2 rounded-full" style="width: ${((currentQuestionIndex + 1) / quizData.length) *
                                100
                                }%"></div>
                        </div>
                    `;
                            document
                                .getElementById("continue-quiz")
...
function displayQuestion() {
    ...
    quizContainer.innerHTML = `
        <h3 class="text-xl font-harry-potter text-yellow-300 mb-4">${questionData.question
        }</h3>
    ...
    // Update progress
    progressContainer.innerHTML = `
        <p class="text-yellow-200">Question ${currentQuestionIndex + 1} of ${quizData.length
        }</p>
        <div class="w-full bg-gray-700 rounded-full h-2">
            <div class="bg-yellow-400 h-2 rounded-full" style="width: ${((currentQuestionIndex + 1) / quizData.length) * 100
        }%"></div>
    ...
    document.querySelectorAll(".wand-quiz-answer").forEach((button) => {
        button.addEventListener("click", () => {
            ...
            console.log(
                `Answer for question ${currentQuestionIndex + 1}:`,
                answerText
            );
...
function showResult() {
    ...
    const flexibility =
        wandData.flexibilities[pride][birthDate] || "reasonably supple";
    ...
    <div class="text-sm text-yellow-200 space-y-2">
        ...
        <p><strong>Core:</strong> ${wandDescriptions.cores[core] || "A reliable core for versatile magic."
        }</p>
        <p><strong>Flexibility:</strong> ${wandDescriptions.flexibilities[flexibility] ||
        "A balanced flexibility for varied spellcasting."
        }</p>
    </div>
`;
